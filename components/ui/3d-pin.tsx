...
export const PinContainer = ({
    ...
    // Avoid hydration mismatch: render static placeholder until client mount.
    // Framer-motion (PinPerspective) outputs different DOM on server vs client when inside <a>.
    if (!mounted) {
        return (
            <a
                href={href || "/"}
