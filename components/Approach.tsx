        ...
        <section className="w-full py-20">
            ...
            <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
                <Card
                    ...
                    description="I will collaborate to map out your website's goals, target audience, and key functionalities. I'll discuss things like site structure, navigation and content requirements."
                >
                    <CanvasRevealEffect
                        animationSpeed={5.1}
    ...
    return (
        <div>
            <button className="relative inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
                ...
                <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-slate-950 px-10 py-4 font-medium text-white backdrop-blur-3xl text-2xl font-bold">
                    {order}
                </span>
            </button>
        </div>
